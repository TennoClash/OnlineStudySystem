...
<body class="sticky-header">
	...
	<div class="main-content">
		...
		<table border="1" style="text-align:center;margin-left:30px"> 
					<strong>按用户搜索：</strong>
						<form action="RecordTableAdmin" method="get" class="form-search"> 
	 			...
	 			<section class="panel">
					...
					<center>  
						<label>第${page.currentPage}/${page.totalPage}页
							共${page.totalRows}条</label> <a href="RecordTableAdmin?currentPage=0">首页</a> <a
							href="RecordTableAdmin?currentPage=${page.currentPage-1}" 
							onclick="return checkFirst()">上一页</a> <a 
							href="RecordTableAdmin?currentPage=${page.currentPage+1}"
							onclick="return checkNext()">下一页</a> <a
							href="RecordTableAdmin?currentPage=${page.totalPage}">尾页</a> 跳转到: <input
