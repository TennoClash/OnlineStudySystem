...
<script src="/weiduo/plugin/script/excel.js"></script>
        ...
        $("#testDo").on("click",function(){
            ...
            $.ajax({
                ...
                success : function(data) {
                    console.log(data);
                    $.each(data,function(i,v){
                        $tr='<tr><td>'+v.realName+'</td><td>'+v.userName+'</td><td>'+v.email*100+'%'+'</td><td>可进行考试</td></tr>';
                        $("#table").append($tr);
                    })
...
<body class="sticky-header">
    ...
    <div class="main-content">
        ...
        <a href="/weiduo/info">
         <button class="btn btn-success btn-lg btn-block" id="testDo2"  type="button">导出至excel</button>
         </a>
        </div>
        <!--body wrapper end-->
