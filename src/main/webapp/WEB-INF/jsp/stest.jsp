...
<body class="sticky-header">
	...
	<div class="main-content">
		...
		<!-- page heading start-->
		<div class="page-heading">考试查询</div>
		<!-- page heading end-->
...
<div>
	<table border="1" style="text-align: center; margin-left: 30px">
				<strong>按批次搜索：</strong>
				<form action="testTable2" method="get" class="form-search">
			...
			<div class="panel-body" id="upanel">
				<table class="table table-striped">
					...
					<tbody>
						...
						<c:if test="${s.userName==user_number}">
							<tr>
								<td>${s.batchName}</td>
								<td>${s.realName}</td>
								<td>${s.userName}</td>
			...
			<center>
				<label>第${page.currentPage}/${page.totalPage}页
					共${page.totalRows}条</label> <a href="testTable2?currentPage=0">首页</a> <a
					href="testTable2?currentPage=${page.currentPage-1}"
					onclick="return checkFirst()">上一页</a> <a
					href="testTable2?currentPage=${page.currentPage+1}"
					onclick="return checkNext()">下一页</a> <a
					href="testTable2?currentPage=${page.totalPage}">尾页</a> 跳转到: <input
